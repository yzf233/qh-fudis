    ...
    implements Map<K,V>, Cloneable, Serializable
{
     ...
     */
    public VHashMap(int initialCapacity, float loadFactor) {
     ...
     */
    public VHashMap(Map<? extends K, ? extends V> m) {
    ...
    static int hashCode(byte[] digest) {
     ...
     * Check for equality of non-null reference x and possibly-null y.
     */
    static boolean eqArray(Object x, Object y) {
        return x == y || x.equals(y) || Arrays.equals((byte[])x , (byte[])y);
    }
    /**
    ...
    public V getB(Object key) {

        Object k = maskNull(key);
        int hash = hashCode((byte[])k);
        int i = indexFor(hash, table.length);
        ...
        while (true) {
            if (e == null)
                return null;
//            System.out.println("º”‘ÿª∫¥Ê£∫" + XDIoTest.byte2String((byte[])key) +"    i:"+i+"    E.K:"+XDIoTest.byte2String((byte[])e.key));
            if (e.hash == hash && eqArray(k, e.key))
                return e.value;
            e = e.next;
        }
    }
    ...
    static class Entry<K,V> implements Map.Entry<K,V> {
        ...
        public K getKey() {
            return VHashMap.<K>unmaskNull(key);
        }
         ...
         * in the HashMap.
         */
        void recordAccess(VHashMap<K,V> m) {
        }
         ...
         */
        void recordRemoval(VHashMap<K,V> m) {
        }
    }
    ...
    private abstract class HashIterator<E> implements Iterator<E> {
        ...
        public void remove() {
            ...
            current = null;
            VHashMap.this.removeEntryForKey(k);
            expectedModCount = modCount;
        }
    ...
    private class KeySet extends AbstractSet<K> {
        ...
        public boolean remove(Object o) {
            return VHashMap.this.removeEntryForKey(o) != null;
        }
        public void clear() {
            VHashMap.this.clear();
        }
