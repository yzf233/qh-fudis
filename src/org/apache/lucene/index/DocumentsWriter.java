...
final class DocumentsWriter {
  ...
  private final static int MAX_THREAD_STATE = 1000;
  ...
  static class DocState {
    ...
    {
    	return SearchContext.getIndexField(field)!=null?SearchContext.getAnalyzer(SearchContext.getIndexField(field).getTokentype()): analyzer;
    }
