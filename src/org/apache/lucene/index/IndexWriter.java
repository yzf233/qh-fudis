...
public class IndexWriter {
  ...
  public void addDocument(Document doc, Analyzer analyzer) throws CorruptIndexException, IOException {
    ...
    try {
      try {
        ...
        if(RuntimeDataCollect.isSynchroIsRunning()&&!ImDistributedTool.isReady){
        	SerializableObject serializableObject=new SerializableObject(SearchContext.tempDataPath,"");
        	serializableObject.writeObject(doc);
        }
        success = true;
      } finally {
        if (!success) {
  ...
  */
  ...
  /**
   * ·µ»ØsegmentInfoµÄsize qh 09/02/24
   * @throws CorruptIndexException
   * @throws IOException
   */
  public int getSegmentsSize() throws CorruptIndexException, IOException{
//	  System.out.println(segmentInfos.size());
