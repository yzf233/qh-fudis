...
public class QueryParser implements QueryParserConstants {
	...
	boolean lowercaseExpandedTerms = false;//对于范围搜索和模糊搜索不进行小写转换 胡俊
	...
	protected Query getFieldQuery(String field, String queryText)
		...
		IndexField indexField = field!=null ? SearchContext.getIndexField(field):null ;
		TokenStream source;
		source = SearchContext.getAnalyzer(indexField!=null && indexField.isToken()?indexField.getTokentype():0).tokenStream(field, new StringReader(queryText));
