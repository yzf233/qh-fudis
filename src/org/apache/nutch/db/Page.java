...
public class Page implements WritableComparable, Cloneable {
  ...
  public Page(String urlString, float score , int isParseOutLink)
    throws MalformedURLException {
    this(urlString, score, score, System.currentTimeMillis());
    this.setIsParseOutLink(isParseOutLink);
  }
  public Page(String urlString, float score , int isParseOutLink,int formdb)
    throws MalformedURLException {
    this(urlString, score, score, System.currentTimeMillis());
    this.setIsParseOutLink(isParseOutLink);
    this.setFromdb(formdb);
  }

  public Page(String urlString, float score , int isParseOutLink,String extra)
      throws MalformedURLException {
      this(urlString, score, score, System.currentTimeMillis());
      this.setIsParseOutLink(isParseOutLink);
      this.extra = extra ;
  ...
  public Page(byte retries,int numOutlinks ,String urlString, float score, float nextScore, long nextFetch)
    throws MalformedURLException {
    setURL(urlString);
  ...
  public void write(DataOutput out) throws IOException {
    ...
    UTF8.writeString(out, extra!=null?extra:"");
  ...
  public String toTabbedString() {
      ...
      buf.append(getFromdb()); buf.append("\t");
      return buf.toString();
  }
