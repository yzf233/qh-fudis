...
import com.xx.platform.core.io.XDLocalFileSystem;
...
public abstract class NutchFileSystem {
    ...
    /** Returns the default filesystem implementation.*/
        public static NutchFileSystem getXDFS() throws IOException {
          return getNamed("xdfs");
    }
    ...
    public static NutchFileSystem getNamed(String name) throws IOException {
      ...
      if (fs == null) {
        ...
        }else if ("xdfs".equals(name)) {
        fs = new XDLocalFileSystem();
      } else {
    ...
    public abstract NFSOutputStream open(File f ,boolean append) throws IOException;
    /**
