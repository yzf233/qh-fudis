...
public class BasicIndexingFilter implements IndexingFilter {
    ...
    public Document filter(Document doc, Parse parse, FetcherOutput fo , Content content) throws
            IndexingException {
...
//            doc.add(new Field("site", host, Field.Store.YES, Field.Index.UN_TOKENIZED));
//        }
//
