 ...
 *******************************************************/
public class TaskTracker implements MRConstants, TaskUmbilicalProtocol, MapOutputProtocol, Runnable, ServiceInterface {
  private static final String SERVICE_NAME = "TaskTracker " ;
  private static final int MAX_CURRENT_TASKS =
    ...
    LogFormatter.getLogger("org.apache.nutch.mapReduce.TaskTracker");
