...
public final class ParseText extends VersionedWritable {
   ...
   * @throws IOException
   */
  public void readFieldsNoCompressed(DataInput in) throws IOException {
	    super.readFields(in);                         // check version
   ...
   * @throws IOException
   */
  public final void writeNoCompressed(DataOutput out) throws IOException {
	    super.write(out);                             // write version
   ...
   * @throws IOException
   */
  public final static ParseText readNoCompressed(DataInput in) throws IOException {
	    ParseText parseText = new ParseText();
	    parseText.readFieldsNoCompressed(in);
	    return parseText;
	  }
  //
  // Accessor methods
