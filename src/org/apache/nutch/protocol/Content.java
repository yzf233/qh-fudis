...
public final class Content extends VersionedWritable {
  ...
  public Content(String url, String title, byte[] content, String contentType,
                 Properties metadata){
  ...
  public final void readFields(DataInput in) throws IOException {
    ...
    flag= UTF8.readString(in);                    // read flag
    url = UTF8.readString(in);                    // read url
    title = UTF8.readString(in);                   // read base
  ...
  public final void write(DataOutput out) throws IOException {
    ...
    UTF8.writeString(out, flag);  
    UTF8.writeString(out, url);                   // write url
    UTF8.writeString(out, title);                  // write base
...
public static Content read(DataInput in) throws IOException {
  ...
  public void setMetadata(Properties metadata) { this.metadata = metadata; }
