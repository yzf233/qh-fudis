...
public class Hit implements Writable, Comparable {
  ...
  private boolean isSort=true;//是否使用compareTo方法进行排序;为false时compareTo排序失效
  public Hit() {}
  ...
  public Hit(int indexNo, int indexDocNo,
          ...
          String dedupValue) {
 this(indexDocNo, sortValue, dedupValue,0);
 this.indexNo = indexNo;
}
  public Hit(int indexNo, int indexDocNo,
             WritableComparable sortValue,
             String dedupValue,float score) {
    this(indexDocNo, sortValue, dedupValue,0);
    this.indexNo = indexNo;
    this.score = score;
  }
  
  public Hit(int indexNo, int indexDocNo, WritableComparable sortValue,
          String dedupValue,float score,boolean isSort) {
	  this(indexNo,indexDocNo,sortValue,dedupValue,score);
	  this.isSort=isSort;
  }
  
  public Hit(int indexDocNo, WritableComparable sortValue, String dedupValue,float score) {
